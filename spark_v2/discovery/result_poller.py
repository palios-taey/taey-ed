"""Poll discovery-loop artifacts written to disk."""
...
def find_active_discovery_request(platform: str) -> str | None:
    prefix = f"discovery_{platform}_"
    matches: list[str] = []
    if not DISCOVERY_DIR.exists():
        return None
    for child in DISCOVERY_DIR.iterdir():
